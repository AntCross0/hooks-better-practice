        ...
        { 
          ...
          todos.map((todo) => (
            ...
            <div key={ todo.id } 
             ...
             bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 p-2 transition-all'>
              <div 
              onClick={ () => { handleToggle(todo.id) } }
              className={ todo.done === true ? 'complete flex justify-between space-x-3 rounded py-3 px-2 group-hover:bg-gray-200': 'flex justify-between space-x-3 rounded py-3 px-2 group-hover:bg-gray-200'}>
                ...
                overflow-x-hidden hover:bg-red-500 after:bg-green-400' 
                >Delete
